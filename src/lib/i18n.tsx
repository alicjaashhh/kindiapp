...
const dict = {
  ru: {
    ...
    notes: 'Заметки', notePlaceholder: 'Напишите заметку о дне...', addNote: 'Добавить заметку',
    main: 'Основное', additional: 'Дополнительно', noRecords: 'Записей нет', birthday: 'День рождения',
  ...
  en: {
    ...
    notes: 'Notes', notePlaceholder: 'Write a note about the day...', addNote: 'Add note',
    main: 'Main', additional: 'Additional', noRecords: 'No records', birthday: 'Birthday',
