...
2. Все данные о ребёнке хранятся конфиденциально и используются только для рекомендаций.
3. Мы не несём ответственности за медицинские решения — обращайтесь к врачу.
4. Запрещено использовать приложение для коммерческих целей без разрешения.
5. Возрастные нормы и рекомендации носят ознакомительный характер.
6. Аккаунт может быть удалён в любой момент по вашему запросу.`;

const PRIVACY = `Политика конфиденциальности Kindi Baby

1. Мы собираем: email, имя ребёнка, дату рождения, фото, данные о развитии.
2. Данные хранятся в защищённой облачной базе данных.
3. Мы не передаём ваши данные третьим лицам.
4. Вы можете в любой момент запросить удаление данных.
5. Для аналитики используются обезличенные данные.
6. Контакт: support@kindi.app`;
